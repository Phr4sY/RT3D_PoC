...
public class Population : MonoBehaviour
{
	...
	void Update(){
		...
		//Debug.Log(carControllers.OrderBy(car => car.distance).ToList());
		Debug.Log("Tell me my parent: " + makeChild(sortAndSelectCarsForFitness(carControllers)[0], sortAndSelectCarsForFitness(carControllers)[1]));
	}
